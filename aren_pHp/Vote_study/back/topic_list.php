...
?>
    <li class="list-row">
        ...
        <div class="list-item">
            <button onclick="location.href='./backend.php?do=edit_vote.php?id=<?=$row['id'];?>'">編輯</button>
            <button onclick="location.href='./backend.php?do=del_vote.php?id=<?=$row['id'];?>'">刪除</button>
