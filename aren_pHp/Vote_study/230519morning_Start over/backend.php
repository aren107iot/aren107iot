...
?>
            <li class="list-row">
                ...
                <div class="list-item">
                <?=$row['open_time'] ." ~ ". $row['close_time'];?></div>
                <div class="list-item"></div>
                <div class="list-item">
                <button onclick="location.href='./back/edit_vote.php?id=<?=$row['id'];?>'">edit</button>
                    <button onclick="location.href='./back/del_vote.php?id=<?=$row['id'];?>'">delete</button>
                </div>
